...
public class ContQuery extends BaseQuery {
	...
	private Long shardStart;
	private Long shardEnd;

	public Long getShardEnd() {
		return shardEnd;
	}

	public void setShardEnd(Long shardEnd) {
		this.shardEnd = shardEnd;
	}

	public Long getShardStart() {
		return shardStart;
	}

	public void setShardStart(Long shardStart) {
